...
PATH_TO_CKPT = 'model.pb/frozen_inference_graph.pb'
PATH_TO_LABELS = 'model.pb/label_map.pbtxt'
MODEL_BASE = 'file:///Users/woody/models/research'
...
TEST_IMAGE_DIR="model.pb/images"
for i in range(6,10):
